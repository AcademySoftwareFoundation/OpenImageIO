...
def io_create_test():
    ...
    spec = oiio.ImageSpec() 
    # test 1
    out1 = oiio.ImageOutput.create("../../../oiio-testimages/tahoe-gps.jpg", plugin_path)
    if out1 == None:
...
def io_spec_test():
    ...
    out_s = oiio.ImageOutput.create("../../../oiio-testimages/tahoe-gps.jpg", plugin_path)
    if out_s == None:
...
def io_open_test(spec_o):
    ...
    out_o = oiio.ImageOutput.create("../../../oiio-testimages/tahoe-gps.jpg", plugin_path)
    if out_o == None:
...
def io_write_image_test(arr, spec_wi):    
    ...
    out_wi = oiio.ImageOutput.create("../../../oiio-testimages/tahoe-gps.jpg", plugin_path)
    out_wi.open("../../../oiio-testimages/tahoe-gps-test1.jpg", spec_wi, False)
    if out_wi == None:
    ...
    out_wi.open("../../../oiio-testimages/tahoe-gps-test2-brighten.jpg", spec_wi, False)
    arr2 = arr[:]
    ...
    out_wi.open("../../../oiio-testimages/tahoe-gps-test3.jpg", spec_wi, False)        
    try:
    ...
    out_wi.open("../../../oiio-testimages/tahoe-gps-test4.jpg", spec_wi, False)
    arr4 = arr[::-1]
    ...
    # test 5
    out_wi.open("../../../oiio-testimages/tahoe-gps-test5-strides.jpg", spec_wi, False)
    ...
    # test 6
    out_wi.open("../../../oiio-testimages/tahoe-gps-test6-callback.jpg", spec_wi, False)
...
def io_copy_image_test(image_input, spec_ci):
    ...
    out_ci = oiio.ImageOutput.create("../../../oiio-testimages/tahoe-gps.jpg", plugin_path)
    out_ci.open("../../../oiio-testimages/tahoe-gps-copy.jpg", spec_ci, False)
    if out_ci == None:
        print "Can't opet test image, skipping write_image() tests"
        print
        return
...
def io_format_name_test(spec_fn):
    ...
    out_fn = oiio.ImageOutput.create("../../../oiio-testimages/tahoe-gps.jpg", plugin_path)
    out_fn.open("../../../oiio-testimages/tahoe-gps-fn.jpg", spec_fn, False)
    # test 1
...
def io_supports_test(spec_su):
    ...
    out_su = oiio.ImageOutput.create("../../../oiio-testimages/tahoe-gps.jpg", plugin_path)
    out_su.open("../../../oiio-testimages/tahoe-gps-fn.jpg", spec_su, False)
    # test 1
...
def io_error_message_test(spec_em):
    ...
    out_em = oiio.ImageOutput.create("../../../oiio-testimages/tahoe-gps.jpg", plugin_path)
    out_em.open("../../../oiio-testimages/tahoe-gps-fn.jpg", spec_em, False)
    # test 1
    test1 = "passed"
    try:
...
def io_write_scanline_test():
    ...
    pic_ws = oiio.ImageInput.create("../../../oiio-testimages/tahoe-gps.jpg", plugin_path)
    pic_ws.open("../../../oiio-testimages/tahoe-gps.jpg", spec_ws)
    
    #create IO instance and open a file for writing
    out_ws = oiio.ImageOutput.create("../../../oiio-testimages/tahoe-gps-scanline.jpg", plugin_path)
    out_ws.open("../../../oiio-testimages/tahoe-gps-scanline.jpg", spec_ws, False)
