...
if (USE_REDSDK)
    find_package (R3DSDK)
    if (RED_INCLUDE_DIR AND RED_LIBRARIES)
        set (RED_FOUND TRUE)
        if (NOT RedSDK_FIND_QUIETLY)
            message (STATUS "REDSDK includes = ${RED_INCLUDE_DIR}")
            message (STATUS "REDSDK library = ${RED_LIBRARIES}")
        endif ()
        include_directories (${RED_INCLUDE_DIR})
    else ()
