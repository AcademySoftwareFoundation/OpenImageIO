...
\begin{code}
        ...
        ImageOutput::unique_ptr out = ImageOutput::create (filename);
        if (! out)
            return;
...
\begin{code}
        ImageOutput::unique_ptr out = ImageOutput::create ("myfile.tif");
        ImageSpec spec (xres, yres, channels, TypeDesc::UINT16);
        out->open (filename, spec);
        ...
...
\begin{code}
        ...
        ImageOutput::unique_ptr out = ImageOutput::create ("foo.exr");
...
\begin{code}
    ...
    ImageInput::unique_ptr in = ImageInput::open (input);
    ...
    ImageOutput::unique_ptr out = ImageOutput::create (output);
...
\begin{code} 
        ...
        ImageOutput::unique_ptr out = ImageOutput::create (filename, mysearch);
        ...
\end{code} % $
...
\apiitem{static ImageOutput::unique_ptr {\ce create} (const std::string \&filename, \\
