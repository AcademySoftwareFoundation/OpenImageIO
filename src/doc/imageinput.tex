...
\apiitem{ImageInput * {\ce create} (const char *filename, 
...
\apiitem{bool {\ce open} (const char *name, ImageSpec \&newspec)}
...
\apiitem{bool {\ce read_scanline} (int y, int z, ParamBaseType format, void *data,\\
...
\apiitem{bool {\ce read_tile} (int x, int y, int z, ParamBaseType format,
...
\apiitem{bool {\ce read_image} (ParamBaseType format, void *data, \\
                             \bigspc stride_t xstride=AutoStride,
