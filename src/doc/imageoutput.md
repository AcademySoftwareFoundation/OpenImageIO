...
- Dimensions (width, height, or number of channels) exceeding the limits
  supported by the file format. [^1]
...
[^1]: One exception to the rule about
...
:::{note}
*Metadata* refers to data about data, in this case, data about the
...
(sec-imageoutput-random-access-pixels)=
...
(sec-imageoutput-class-reference)=
