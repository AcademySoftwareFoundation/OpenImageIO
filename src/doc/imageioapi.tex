...
\bigspc\bigspc\spc                    ImageInput::Deleter input_deleter, \\
\bigspc\bigspc\spc                    const char **input_extensions,\\
\bigspc\bigspc\spc                    ImageOutput::Creator output_creator, \\
\bigspc\bigspc\spc                    ImageOutput::Deleter output_deleter, \\
\bigspc\bigspc\spc                    const char **output_extensions, \\
\bigspc\bigspc\spc                    const char *lib_version)}
Register the input and output `create' and `delete' functions and list of
file extensions for a particular format.
\apiend
