...
{\cf datatype=}\emph{typename} & Set the pixel data type (like {\cf -d})
     for this output image. \\
{\cf bits=}\emph{int} & Set the bits per pixel (if nonstandard for the
     datatype) for this output image. \\
{\cf dither=}{\verb&0|1&} & Turn dither on or off for this output. \\[0.5ex]

{\cf autocc=}{\verb&0|1&} & Enable or disable {\cf --autocc} for
     this output image. \\
{\cf autocrop=}{\verb&0|1&} & Enable or disable autocrop for
     this output image. \\
{\cf autotrim=}{\verb&0|1&} & Enable or disable {\cf --autotrim} for
     this output image. \index{autotrim} \\
{\cf separate=}{\verb&0|1&} & \\
{\cf contig=}{\verb&0|1&} & Set separate or contiguous planar configuration
    for this output. \\
\end{tabular}
