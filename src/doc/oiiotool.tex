...
\apiitem{--pattern fill:top=0.1,0.1,0.1:bottom=0,0,0.5 640x480 3}
\vspace{10pt}
An $640 \times 480$ RGB image that is a gradient ranging from dark grey at
the top, fading to a medium blue at the bottom.

\spc \includegraphics[width=1.75in]{figures/gradient.jpg} 
...
\begin{smallcode}
    oiiotool --create 640x480 3 --fill:top=0.1,0.1,0.1:bottom=0,0,0.5 \
            640x480 -o gradient.tif
\end{smallcode}
\spc \includegraphics[width=2.5in]{figures/gradient.jpg}  \\
