...
{\cf *}, or {\cf /} for simple arithmetic operations. The evaluation is
simple left-to-right order without any special operator precedence.
\end{description}
...
\apiitem{\small oiiotool --pattern noise:type=uniform:max=1 256x256 3 -o colornoise.jpg \\
oiiotool --pattern noise:type=uniform:max=1:mono=1 256x256 3 -o greynoise.jpg}
\vspace{10pt}
