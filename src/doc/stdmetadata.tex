...
7 & transverse (left to right, bottom to top) \\
...
{\bf Exif tag} & {\bf \product metadata} \\
\hline
...
\apiitem{   5, "IPTC:ObjectName" : string}
\apiend
...
\apiitem{  30, "IPTC:Instructions" : string}
\apiend

\apiitem{  80, "IPTC:Creator" : string }
The creator of the image.  This will also be duplicated in the standard
\qkw{Artist} field.
% FIXME?
\apiend

\apiitem{  85, "IPTC:AuthorsPosition" : string}
\apiend
\apiitem{  90, "IPTC:City" : string}
\apiend
\apiitem{  95, "IPTC:State" : string}
\apiend
\apiitem{ 101, "IPTC:Country" : string}
\apiend
\apiitem{ 105, "IPTC:Headline" : string}
\apiend
\apiitem{ 110, "IPTC:Provider" : string}
\apiend
\apiitem{ 115, "IPTC:Source" : string}
\apiend

%\apiitem{ 116, "Copyright" : string}
%\apiend
% FIXME

\apiitem{ 118, "IPTC:Contact" : string}
\apiend
\apiitem{ 120, "IPTC:Caption_Abstract", string }
\apiend
\apiitem{ 122, "IPTC:CaptionWriter" : string}
\apiend
