...
math. See the
[OpenColorIO documentation](https://opencolorio.readthedocs.io) for details.
...
Like any other Python package, OpenImageIO can be used in [Jupyter notebooks](https://jupyter.org/install).
...
Alternatively, if you prefer using [uv](https://github.com/astral-sh/uv), you can run the following command:
