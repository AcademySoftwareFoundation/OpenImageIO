...
\item Declare these public items:
  ...
  \begin{enumerate}
    ...
    \item A void function named \emph{name}{\cf _input_imageio_delete} that
      takes an {\cf ImageInput *} and destroys it.
...
\item Declare four public items:
  ...
  \begin{enumerate}
    ...
    \item A function named \emph{name}{\cf _output_imageio_create} that
      ...
      deleter.  (Note that \emph{name} is the name of your format,
      and must match the name of the plugin itself.)
    \item A void function named \emph{name}{\cf _output_imageio_delete} that
      takes an {\cf ImageOutput *} and destroys it.
