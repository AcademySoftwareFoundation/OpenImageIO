...
\apiitem{const void * {\ce to_native_scanline} (ParamBaseType format,
...
\apiitem{const void * {\ce to_native_tile} (ParamBaseType format, const
  void *data,\\ \bigspc
...
\apiitem{const void * {\ce to_native_rectangle} (int xmin, int xmax, int
  ymin, int ymax, \\ \bigspc
                                     int zmin, int zmax, 
                                     ParamBaseType format, const void
                                     *data, \\ \bigspc
