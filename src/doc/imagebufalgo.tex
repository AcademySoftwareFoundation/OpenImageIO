...
\apiitem{bool clamp (ImageBuf \&dst, const ImageBuf \&src, \\
...
bool clamp (ImageBuf \&dst, const ImageBuf \&src, \\
...
\apiitem{bool {\ce unpremult} (ImageBuf \&dst, const ImageBuf \&src, ROI roi=ROI::All(), nthreads=0)}
...
\apiitem{bool {\ce premult} (ImageBuf \&dst, const ImageBuf \&src, ROI roi=ROI::All(), nthreads=0)}
