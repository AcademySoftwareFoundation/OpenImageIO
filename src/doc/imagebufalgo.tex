...
\apiitem{bool cut (ImageBuf \&dst, const ImageBuf \&src, \\
        \bigspc  ROI roi=ROI::All(), int nthreads=0)}
...
\apiitem{bool paste (ImageBuf \&dst, int xbegin, int ybegin, int zbegin,
  int chbegin, \\
...
\apiitem{bool {\ce flipflop} (ImageBuf \&dst, const ImageBuf \&src, \\
        \bigspc  ROI roi=ROI::All(), int nthreads=0)}
...
\apiitem{bool {\ce resize} (ImageBuf \&dst, const ImageBuf \&src, \\
        \bigspc  const std::string filtername="", float filtersize=0, \\
        \bigspc  ROI roi=ROI::All(), int nthreads=0) \\
...
\apiitem{bool {\ce ociolook} (ImageBuf \&dst, const ImageBuf \&src, \\
  ...
  \bigspc\spc const char *key=NULL, const char *value=NULL, \\
  \bigspc\spc ROI roi=ROI::All(), int nthreads=0)}
...
\apiitem{bool {\ce ociodisplay} (ImageBuf \&dst, const ImageBuf \&src, \\
  \bigspc\spc const char *display, const char *view, \\
  \bigspc\spc const char *from=NULL, const char *looks=NULL,\\
