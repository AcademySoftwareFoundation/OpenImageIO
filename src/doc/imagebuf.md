...
> :::{note}
> `ImageBuf::ConstIterator` is identical to the Iterator,
...
[^1]: ImageCache only supports a limited set of types internally, currently
...
from Section [Example: Set all pixels in a region to black](#example-set-all-pixels-in-a-region-to-black)
