...
* - ```{image} figures/text.jpg
    :width: 2.5 in
    :alt: textimg1
    ```
  - ```{image} figures/textcentered.jpg
    :width: 2.5 in
    :alt: textimg2
    ```
::::
...
* - ```{image} figures/tahoe-small.jpg
    ...
    :alt: ccmat1
    ```
  - ```{image} figures/tahoe-ccmatrix.jpg
    :width: 1.5 in
    :alt: ccmat2
    ```
* - original
