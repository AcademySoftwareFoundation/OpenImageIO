...
{\ce ImageSpec} (roi, basetype) \\
{\ce ImageSpec} (roi, typespec)}
...
\apiitem{int DeepData.{\ce A_channel} (c) const}
\NEW % 1.8
...
\apiitem{bool ImageBufAlgo.{\ce deep_cull} (dst, src, holdout, roi=ROI.All, nthreads=0)}
...
\begin{code}
    ...
    ImageBufAlgo.deep_cull (Thresholded, Img, Mask)
\end{code}
\apiend
