...
\noindent Example:
\begin{code}
    spec = oiio.ImageSpec (640, 480, 3, oiio.FLOAT)
...
\begin{code}
    ...
    buf = oiio.ImageBuf()     # 1 - assign a new blank ImageBuf
...
\noindent Example:
\begin{code}
    buf = oiio.ImageBuf ("mytexture.exr")
    buf.read (0, 2, True)
...
\noindent Example:
\begin{code}
    buf = oiio.ImageBuf (oiio.ImageSpec (640, 480, 3, oiio.UINT8))
