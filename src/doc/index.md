...
Editor: Larry Gritz, [lg@openimageio.org](mailto:lg@openimageio.org)
...
Quick Links:
[Web site](https://openimageio.org) /
[GitHub repository](https://github.com/AcademySoftwareFoundation/OpenImageIO) /
[Developer mail list](https://lists.aswf.io/g/oiio-dev) /
[Apache 2.0 License](https://github.com/AcademySoftwareFoundation/OpenImageIO/blob/main/LICENSE.md)
:::
