...
struct RendererBackendVTable {
    ...
    bool (*create_texture)(RendererState& renderer_state,
                           const LoadedImage& image, RendererTexture& texture,
    ...
    bool (*wait_idle)(RendererState& renderer_state, std::string& error_message)
        = nullptr;
    ...
    void (*frame_render)(RendererState& renderer_state, ImDrawData* draw_data)
        = nullptr;
