...
#ifndef OIIO_DOXYGEN
OIIO_NAMESPACE_BEGIN
using OIIO::v3_1::null_mutex;
using OIIO::v3_1::null_lock;
using OIIO::v3_1::atomic_backoff;
using OIIO::v3_1::spin_mutex;
using OIIO::v3_1::spin_rw_mutex;
using OIIO::v3_1::mutex_pool;
using OIIO::v3_1::thread_group;
using OIIO::v3_1::thread_pool;
using OIIO::v3_1::task_set;
using std::mutex;
using std::recursive_mutex;
using std::thread;
using lock_guard = std::lock_guard<mutex>;
...
using spin_rw_read_lock = spin_rw_mutex::read_lock_guard;
using spin_rw_write_lock = spin_rw_mutex::write_lock_guard;
inline thread_pool* default_thread_pool() { return OIIO::v3_1::default_thread_pool(); }
inline void default_thread_pool_shutdown() { OIIO::v3_1::default_thread_pool_shutdown(); }
OIIO_NAMESPACE_END
#endif
// clang-format on
