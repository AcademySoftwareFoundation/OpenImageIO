...
static ExrMeta exr_meta_translation[] = {
    ...
    ExrMeta("openexr:CameraTemperature", "cameraCCTSetting", TypeFloat),
    ExrMeta("openexr:CameraTint", "cameraTintSetting", TypeFloat),
    ExrMeta("NominalFocalLength", "nominalFocalLength", TypeFloat),
    ExrMeta("PinholeFocalLength", "pinholeFocalLength", TypeFloat),
    ...
    ExrMeta("CameraUuid", "cameraUuid", TypeString),
    ExrMeta("CameraLabel", "cameraLabel", TypeString),
