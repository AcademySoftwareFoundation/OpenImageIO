...
static ExrMeta exr_meta_translation[] = {
    ...
    ExrMeta("LensMake", "lensMake", TypeString),
    ExrMeta("LensModel", "lensModel", TypeString),
    ExrMeta("LensSerialNumber", "lensSerialNumber", TypeString),
    ExrMeta("LensFirmwareVersion", "lensFirmwareVersion", TypeString),
    ExrMeta("Longitude", "longitude", TypeFloat),
    ExrMeta("Latitude", "latitude", TypeFloat),
    ExrMeta("Altitude", "altitude", TypeFloat),
