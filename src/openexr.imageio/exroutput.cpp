...
static ExrMeta exr_meta_translation[] = {
    ...
    ExrMeta("Iso", "isoSpeed", TypeFloat),
    ExrMeta("TStop", "Stop", TypeFloat),
    ExrMeta("Focus", "focus", TypeFloat),
    ExrMeta("WhiteBalanceTemperature", "cameraCCTSetting", TypeFloat),
    ExrMeta("WhiteBalanceTint", "cameraTintSetting", TypeFloat),
    ExrMeta("FocalLengthNominal", "nominalFocalLength", TypeFloat),
    ExrMeta("FocalLengthPinhole", "pinholeFocalLength", TypeFloat),
    ExrMeta("FocalLengthEffective", "effectiveFocalLength", TypeFloat),
    ExrMeta("EntrancePupil", "entrancePupilOffset", TypeFloat),
    ExrMeta("PhotositeSensor", "sensorPhotositePitch", TypeFloat),
    ExrMeta("Make", "cameraMake", TypeString),
    ExrMeta("Model", "cameraModel", TypeString),
    ExrMeta("SerialNumber", "cameraSerialNumber", TypeString),
    ExrMeta("FirmwareVersion", "cameraFirmwareVersion", TypeString),
    ExrMeta("Uuid", "cameraUuid", TypeString),
    ExrMeta("Label", "cameraLabel", TypeString),
    ExrMeta("MakeLens", "lensMake", TypeString),
    ExrMeta("ModelLens", "lensModel", TypeString),
    ExrMeta("SerialNumberLens", "lensSerialNumber", TypeString),
    ExrMeta("FirmwareVersionLens", "lensFirmwareVersion", TypeString),
    ExrMeta("GPS:Longitude", "longitude", TypeFloat),
    ExrMeta("GPS:Latitude", "latitude", TypeFloat),
    ExrMeta("GPS:Altitude", "altitude", TypeFloat),
