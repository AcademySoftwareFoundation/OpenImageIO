...
static std::map<std::string, std::string> exr_tag_to_oiio_std {
    ...
    { "isoSpeed", "Iso", },
    { "focus", "Focus", },
    { "cameraCCTSetting", "WhiteBalanceTemperature", },
    { "cameraTintSetting", "WhiteBalanceTint", },
    { "nominalFocalLength", "FocalLengthNominal", },
    { "pinholeFocalLength", "FocalLengthPinhole", },
    { "effectiveFocalLength", "FocalLengthEffective", },
    { "entrancePupilOffset", "EntrancePupil", },
    { "sensorPhotositePitch", "PhotositeSensor", },
    { "cameraMake", "Make", },
    { "cameraModel", "Model", },
    ...
    { "lensMake", "MakeLens", },
    { "lensModel", "ModelLens", },
    { "lensSerialNumber", "SerialNumberLens", },
    { "lensFirmwareVersion", "FirmwareVersionLens", },
