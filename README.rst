...
The primary target audience for OIIO is VFX studios and tool developers
tools being renderers, compositors, viewers, and other image-related
tools you'd find in a production pipeline).
