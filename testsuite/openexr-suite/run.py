...
imagedir = runtest.parent + "/openexr-images-1.5.0/DisplayWindow"

# ../openexr-images-1.5.0/ScanLines:
# Blobbies.exr   Desk.exr       StillLife.exr
# Cannon.exr     MtTamWest.exr  Tree.exr
imagedir = runtest.parent + "/openexr-images-1.5.0/ScanLines"
files = [ "Desk.exr", "MtTamWest.exr" ]
for f in files:
    command = command + runtest.rw_command (imagedir, f)
command = command + runtest.rw_command (imagedir, "Cannon.exr", extraargs="--compression zip")
...
imagedir = runtest.parent + "/openexr-images-1.5.0/TestImages"
...
imagedir = runtest.parent + "/openexr-images-1.5.0/Tiles"
