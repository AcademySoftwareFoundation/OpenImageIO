...
# treats the '|' inside 'Reading|jpeg2000|...' as a shell pipe. Quote the
# pattern with double quotes for the same reason -- cmd.exe does not treat
# single quotes as quoting, so grep would see two arguments.
