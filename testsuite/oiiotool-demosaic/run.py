        ...
        for xx in range(0, 2):
            ...
            for type_dict in dict["types"]:
                ...
                for algo in ['linear', 'MHC']:
                    ...
                    command += oiiotool (f"-i:type={type} testimage.exr -i:type={type} bayer_{pattern}{suffix}.exr --demosaic:algorithm={algo}:layout={pattern}:white_balance={WB_R},{WB_G1},{WB_G2},{WB_B} -o:type={type} result_{type}_{pattern}{suffix}-{algo}.{ext} ")
