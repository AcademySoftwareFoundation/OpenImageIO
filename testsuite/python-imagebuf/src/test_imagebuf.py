...
def test_outofrange_subimage_miplevel() :
    ...
    for f in [ "bayer.png", "grid-small.exr" ] :
        buf = oiio.ImageBuf()
        buf.init_spec("../common/" + f, 1, 0)
        print(" ", f, "subimage 1 mip 0:", buf.geterror())
        buf = oiio.ImageBuf()
        buf.init_spec("../common/" + f, 0, 0)
        print(" ", f, "subimage 0 mip 0:", buf.geterror())
        buf = oiio.ImageBuf()
        buf.init_spec("../common/" + f, 0, 1)
        print(" ", f, "subimage 0 mip 1:", buf.geterror())
